...
* Jan/20/26 - Gather some information of the old models.
    ...
    * One of them being made November 25, 2024. This model was made out of LEGOS. It was a square that it wasn't very functional because it was large.

    * Other one being made on October 19, 2025. This one was made of 3D print materials. This model took time for it to work but it failed because it was too complex to work (it was 4x4 model). 

    * The actual car model was created on December 22, 2025. This one was also made of 3D print materials. With the past knowledge of vehicles models, it decided to be a smaller model for it to manage best the track, with two sensors in front for it to read the colors of the obstacles (2 APDS9960). 

* From this point on we're going to talk about the progress of this model and progress the team. 

* Jan/21/26 - We review the rules and wrote the ones we thought were more important. 

* Jan/22/26 - We started of viewing a video of microphyton. The mechanic team member started creating a new piece for the readings to be more accurate. We took a brief class of how to program lights (turn on and off). 

* Jan/24/26 - We continued with the process of creating the piece for the accurate readings.

* Jan/27/26 - Our coach explained us what github was and how to use it.

* Jan/30/26 - The piece for the accurate reading was finally printed. 

* Feb/04/26 - We stablish the roles of each member and the programmer was learning how to. 

* Feb/05/26 - We trying to figure out how to make the vehicle park.

* Feb/18/26 - We eliminated the APDS9960 because we weren't be using it for the competition of February 21.
...
* Feb/24/26 - We were working on the documentation.

* Mar/04/26 - After the results of the competition we fixed some problems that we saw. One of them being: 
    * The movility of the front wheels be fixed with a league.

* Mar/26/26 - 3D printed the bevel gear. Changed the old for the new bevel gear.
...
* Apr/01/26 - We worked on all the program. The programator worked on the color readings. The mechanic was making a piece for the vehicle to be sustainable.

* Apr/02/26 - We tested out the program we work on yesterday on the track. After testing worked more on the program.

* Apr/07/26 - We work on the program and while working on it a Pin of one connector broked. So, the mechanic fixed it (the errors that appeared on the program were ERROR 19 and E10)
